(function ($) {
  $(function () {
    var slider = $(".mini-slider").flickity({
      imagesLoaded: true,
    ...
    flkty.on("settle", () => {
      $(".mini-card").removeClass("is-custom-selected");
    ...
    $(".card-body").addClass("animation-reveal");
    $(".mini-carousel").css("opacity", "0");
    flkty.resize();
    flkty.reposition();
    setTimeout(() => {
      $(".card-body").removeClass("animation-reveal");
